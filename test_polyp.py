...
if __name__ == '__main__':
    ...
    #model.load_state_dict(torch.load("model_pth\DualHDA3_polyp_4.29\DualHDA3_polyp-last.pth"))
    model.load_state_dict(torch.load("model_pth\Polyp\HDA3\99DualHDA3_polyp-best.pth"))
    model.eval()
